 ...
 */
router.get('/:tollStationID/:date_from/:date_to', authenticateToken, authorizeRole(ANALYTICS_ROLES), enforceCompanyScope('tollStationID'), tollStationsPasses_controller.getTollStationPasses);
